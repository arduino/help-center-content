...
8. Start using [Arduino Cloud](https://app.arduino.cc/) and [Cloud Editor](https://create.arduino.cc/editor) apps right away, or check the [Resources tab](https://app.arduino.cc/resources) for help getting started.
...
3. Start using [Arduino Cloud](https://app.arduino.cc/) and [Cloud Editor](https://create.arduino.cc/editor) apps right away, or check the [Resources tab](https://app.arduino.cc/resources) for help getting started.
