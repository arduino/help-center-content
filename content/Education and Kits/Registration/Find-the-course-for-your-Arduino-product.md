...
| Arduino Greenhouse Kit                 | [Course](https://greenhouse-kit.arduino.cc/){.link-external}<br>_Paid plan requried to complete all content._                                                                                                             |
| Arduino Oplà IoT Kit                   | [Course](https://opla.arduino.cc/){.link-external}<br>_Paid plan requried to complete all content._                                                                                                                       |
