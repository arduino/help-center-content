...
1. Install the [ArduinoMotorCarrier library](https://docs.arduino.cc/libraries/arduinomotorcarrier/). (See [Install libraries in the Arduino IDE](https://support.arduino.cc/hc/en-us/articles/5145457742236-Install-libraries-in-the-Arduino-IDE) for instructions)
